...
class QLayoutConstraint {
    ...
    static func equalConstraint(firstView: UIView, secondView: UIView, attribute: NSLayoutAttribute) -> NSLayoutConstraint {
    ...
    static func constantConstraint(view: UIView, attribute: NSLayoutAttribute, value: CGFloat) -> NSLayoutConstraint {
    ...
    static func lessThanOrEqualConstraint(view: UIView, attribute: NSLayoutAttribute, value: CGFloat) -> NSLayoutConstraint {
    ...
    static func paddingPositionConstraints(view: UIView, sides: [NSLayoutAttribute], padding: CGFloat) -> [NSLayoutConstraint] {
        return sides.map { QLayoutConstraint.paddingPositionConstraint(view: view, side: $0, padding: padding) }
    }
